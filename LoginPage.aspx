...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="SignInLBL" style="font-size: 24px;" runat="server" Text="Sign In"></asp:Label>
    ...
    <asp:Button ID="SignInBtn" runat="server" type="button" Text="Sign In" style =" height: 40px;width:80px; border-radius: 5px; border: 2px solid powderblue; margin-top: 10px" OnClick="signIn_Click" />
    <li><a runat="server" href="~/signUpPage">dont have an account? press here</a></li> 
